  ...
  const handleAdd = async (e) => {
    ...
    if (tokenData && userId) {
      try {
        ...
        const res = await PostData(`blog-category-add`, data, "", `Bearer ${tokenData}`);
        if (res.data) {
    ...
    <div className="sidebar_sec_rgt">
      ...
      <div className="table-bx-main">
        <div className="table-title">
          <h4>Add Category</h4>
          <Link href="/dashboard/blog/addblog" className="btn-back">
                    ...
                    <div className="form-group">
                      ...
                      <div className="file-upload">
                        <div className="file-select">
                          ...
                          <input type="file" name="category_image" onChange={handleChange} accept="image/*" required />
                        </div>
                      </div>
                    </div>
                  </div>
